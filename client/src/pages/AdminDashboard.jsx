                    ...
                    <div className="container-custom" style={{ maxWidth: '1200px', margin: '0 0', padding: 0 }}>
                        ...
                        <div className="animate-fadeInUp stagger-2" style={{
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                                <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: 'white' }}>Recent System Activity</h2>
                                <span style={{ color: 'var(--coral-400)', fontSize: '0.9rem', cursor: 'pointer', fontWeight: 600 }}>View All Logs</span>
                            </div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                {recentActivities.map(activity => (
                                    <div key={activity.id} style={{
                                        ...
                                        <div style={{ flex: 1 }}>
                                            <div style={{ color: 'white', fontWeight: 500 }}>{activity.text}</div>
                                            <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.8rem' }}>{activity.time}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
